...
lazy val scoverageSettings = {
  ...
  Seq(
    ...
    ScoverageKeys.coverageExcludedPackages := "<empty>;.*views.*;.*prod.*;.*test.*;app.routes;testOnlyDoNotUseInAppConf;prod.*;app;controllers.javascript;com.kenshoo.play.metrics.*;",
