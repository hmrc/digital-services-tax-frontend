...
import it.uk.gov.hmrc.digitalservicestaxfrontend.util.FakeApplicationSetup
import it.uk.gov.hmrc.digitalservicestaxfrontend.util.TestInstances._
...
class MongoPersistenceSpec extends FakeApplicationSetup {
